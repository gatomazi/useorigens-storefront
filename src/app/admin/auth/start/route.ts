...
/** Starts the Login with Railway flow: a fresh state/nonce/PKCE verifier, kept in a signed HttpOnly cookie, then a redirect to Railway. Production admin host only. */

-- CMS V1 — initial schema. PostgreSQL 15+. Applied ONLY by `npm run db:migrate` (never by a build, a deploy hook or a public route).
...
insert into schema_migration (version) values ('0001_init') on conflict do nothing;
